...
class HomeAssistantClientImplTests {
    ...
    void testJsonLineHAResponse(String jsonBody) throws IOException, InterruptedException, HomeAssistantClientException, HttpStatusException {
